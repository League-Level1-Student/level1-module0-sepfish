...
public class DrumKit implements MouseListener {
    ...
    //     set its default close operation to JFrame.EXIT_ON_CLOSE
   	 ...
   	 String drumName = "drum.jpg";
   	 String hihatName = "hihat.jpg";
   	 // 9. Edit the next line to use your String variable
   	 drumLabelWithImage = createLabelImage(drumName);
   	 hihatLabelWithImage = createLabelImage(hihatName);
   	 // 10. Add the image to the panel
   	 panel.add(drumLabelWithImage);
   	 panel.add(hihatLabelWithImage);
    	...
    	hihatLabelWithImage.addMouseListener(this);
    ...
    public void mouseClicked(MouseEvent e) {
   	...
   	if (drumClicked == hihatLabelWithImage) {
   		playSound("hihat.wav");
   	}
